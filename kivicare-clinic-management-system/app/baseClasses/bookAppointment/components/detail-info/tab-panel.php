        ...
        <div id="kc_register" class="iq-tab-pannel kivicare-register-form-data iq-fade active authActive card-list" >
            <div id="kivicare-register-form">
                <div class="d-grid grid-template-2"  id="kivicare-register">
					...
					<!--- CEDULA. VERSIÓN ANTIGUA SIN RESTRINGIR
					<div class="form-group">
    <label class="form-label" for="cedula">Cédula <span>*</span></label>
    <input type="number" name="cedula" id="cedula" class="iq-kivicare-form-control" placeholder="Ej: 20123456" required>
</div>
FIN --->
<!--- VERSIÓN MEJORADA PARA CEDULA CON RESTRICCIONES -->
<div class="form-group">
    <label class="form-label" for="cedula">Cédula <span>*</span></label>
    <input type="number" 
           name="cedula" 
