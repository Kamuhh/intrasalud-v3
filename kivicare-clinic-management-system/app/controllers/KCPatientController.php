...
class KCPatientController extends KCBase {
    ...
    if ( ! isset( $request_data['ID'] ) ) {
        ...
        // Ahora el username y u_id serán iguales
        $username = sanitize_user($request_data['u_id']);
        $password = kcGenerateString(12);

        // Validar si ya existe ese username (cédula)
        ...
        // GUARDAMOS EL PATIENT UNIQUE ID CON EL MISMO VALOR QUE USERNAME
